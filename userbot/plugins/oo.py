    ...
    if len(o.text) == 0:
        ...
        res = [
                ...
                buttons=[
                    ...
                    [
                        Button.url(
                            text="Repo", url="https://github.com/ANL0KE/ICSS"
                        )
                    ],
                ],
            )
        ]
        await o.answer(res, switch_pm=f"👥 ICSS PORTAL", switch_pm_param="start")


if Config.BOT_USERNAME is not None and asst is not None:
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [
                        Button.url(
                            "⚙️Sᴇᴛᴛɪɴɢs⚙️",
                            url=f"https://t.me/{bnn}?start={bot.me.username}",
                        )
                    ],
    ...
    async def opner(event):
        ...
        buttons = [
            ...
            [
                Button.url(
                    "⚙️Sᴇᴛᴛɪɴɢs⚙️", url=f"https://t.me/{bnn}?start={bot.me.username}"
                )
            ],
            [Button.inline("••Cʟᴏꜱᴇ••", data="close")],
        ]
