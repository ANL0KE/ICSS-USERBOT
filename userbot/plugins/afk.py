    ...
    if AFK_.USERAFK_ON and not (await event.get_sender()).bot:
        ...
        if AFK_.afk_type == "text":
            if AFK_.msg_link and AFK_.reason:
                message_to_reply = (
                    f"𓆩  𝑺𝑶𝑼𝑹𝑪𝑬 𝑰𝑪𝑺𝑺 𝑨𝑭𝑲 𝑴𝑶𝑫𝑬  𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 \n**⌔∮ انا نائم**\n**⌔∮ انا نائم منذو** {endtime}\n**⌔∮ السبب : **{AFK_.reason}"
                )
            elif AFK_.reason:
                message_to_reply = (
                    f"𓆩  𝑺𝑶𝑼𝑹𝑪𝑬 𝑰𝑪𝑺𝑺 𝑨𝑭𝑲 𝑴𝑶𝑫𝑬  𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 \n**⌔∮ انا نائم**\n**⌔∮ انا نائم منذو** {endtime}\n**⌔∮ السبب : **{AFK_.reason}"
                ...
                message_to_reply = f"𓆩  𝑺𝑶𝑼𝑹𝑪𝑬 𝑰𝑪𝑺𝑺 𝑨𝑭𝑲 𝑴𝑶𝑫𝑬  𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 \n**⌔∮ انا نائم**\n**⌔∮ انا نائم منذو** {endtime}\n**⌔∮ السبب : غير مذكور. "
...
async def _(event):
    ...
    if not AFK_.USERAFK_ON:
        ...
        if AFK_.reason:
            ...
            await edit_delete(event, f"**⌔∮ سأذهب الى النوم.** ", 5)
        if BOTLOG:
            if AFK_.reason:
                await event.client.send_message(
                    BOTLOG_CHATID,
