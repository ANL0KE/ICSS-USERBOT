...
Tt = "اولشي مدري شنو هاي هيج اختبار {}\n {}\n{}\n"

@icssbot.on(admin_cmd(pattern="توشه(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="توشه(?: |$)(.*)", allow_sudo=True))
async def who(event):
    ics = await eor(event, "⇆")
...
async def fetch_info(replied_user, event):
   ...
   elif UINFO_TEXT == "True":
       f = Tt.format(username, user_id, user_bio)
