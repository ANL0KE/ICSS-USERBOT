...
@icssbot.on(admin_cmd(pattern="app (.*)"))
@icssbot.on(sudo_cmd(pattern="app (.*)", allow_sudo=True))
async def apk(event):
...
@icssbot.on(admin_cmd(pattern="appr (.*)"))
@icssbot.on(sudo_cmd(pattern="appr (.*)", allow_sudo=True))
